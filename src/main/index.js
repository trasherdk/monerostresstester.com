...
const MNEMONIC = "hefty cigar either unhappy yoyo absorb eskimos lids tsunami sovereign mocked vitals sincerely baptism lifestyle rays onward inmate sushi hitched junk buzzer quote saved sovereign";
const SEED_OFFSET = "";
const RESTORE_HEIGHT = 9041;
